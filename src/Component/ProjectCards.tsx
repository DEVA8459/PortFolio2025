...
import FullProjectModal from "./FullProjectCard";
const ProjectCard = (props: any) => {
    ...
    return <div className="w-[32%] lg-mx:w-[32%] md-mx:w-[48%] sm-mx:w-[90%] xs-mx:w-full xsm-mx:w-full" data-aos="fade-up" data-aos-duration="800"><Card onClick={open}  className="!bg-bg cursor-pointer transition-transform duration-300 ease-in-out hover:!scale-[1.02] mb-5 hover:!shadow-[0_0_10px_1px_#64FFDA80] xs-mx:!shadow-[0_0_10px_1px_#64FFDA80] !border-primary border-2"  shadow="lg" padding="sm" radius="lg" withBorder>
