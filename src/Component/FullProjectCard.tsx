...
const FullProjectCard = (props: any) => {
    ...
    return <Modal.Root scrollAreaComponent={ScrollArea.Autosize} size="auto" centered className=" font-mono" opened={props.opened} onClose={props.close}>
        ...
        <Modal.Content className="!rounded-3xl">
            <Modal.Header className="!bg-bg xs-mx:!p-2  !border-primary  !border-2 !border-b-0 !rounded-tl-3xl !rounded-tr-3xl">
                ...
                <Modal.CloseButton size="md" iconSize="30px" className="!bg-bg !text-red-500" />
            </Modal.Header>
            <Modal.Body className="!bg-bg xs-mx:!p-2 !pt-2 !border-primary  !border-2 !border-t-0 !rounded-bl-3xl !rounded-br-3xl">
                <Image
                ...
                <Group justify="space-between" mt="md" mb={3} >
                    <a href={props.github} target="_blank" className="!w-[48%] sm-mx:!w-[46%]" rel="noreferrer"><Button variant="outline" size={btn} color="#64FFDA" fullWidth  radius="md">
                        View Code
                    </Button>
                    </a>
                    <a href={props.link} target="_blank" className="!w-[48%] " rel="noreferrer"><Button size={btn} color="#64FFDA" className="!text-bg" fullWidth radius="md">
                        View Live App
                    </Button></a>
                </Group>
            </Modal.Body>
